...
def save_plot(history, name, cut):
    ...
    print("top1: {0:.4f}".format(history['categorical_accuracy'][-1], 4))
    print("top5: {0:.4f}".format(history['top_k_categorical_accuracy'][-1], 4))
    print("vtop1: {0:.4f}".format(history['val_categorical_accuracy'][-1]))
    print("vtop5: {0:.4f}".format(history['val_top_k_categorical_accuracy'][-1]))
